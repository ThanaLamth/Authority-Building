# Swapzone x Authority-Building — Master Brief Index
**Client:** Swapzone.io (crypto exchange aggregator)
**Created:** 2026-07-29
**Total:** 20 bài | 3 sites

---

## Quick reference: Bài nào ? site nào
...
| 20 | AUD to BTC Exchange: Best Rate for Australian Users 2026 | Kanalcoin | P1 | kanalcoin-swapzone-briefs.md |

---

## Publish order (quick wins first)

**Week 1 — publish these 6 first:**
- Bài 05: BTC to XMR (Coinwy) — Godex ranking here, winnable
- Bài 16: EUR to XMR (Kanalcoin) — near-zero competition
- Bài 11: Swapzone vs ChangeNOW (Coinwy) — branded, low KD
- Bài 12: Swapzone vs SwapSpace (Coinwy) — aggregator-vs-aggregator, underserved
- Bài 14: No-KYC exchanges (Kanalcoin) — P0 SEA angle
- Bài 15: EUR to BTC (Kanalcoin) — fiat pair, P0

**Week 2:**
- Bài 01 (hub — internal links need week 1 articles to exist first)
- Bài 03, 06, 13
...
### Swapzone là affiliate — framing quan tr?ng
- KHÔNG nói "Swapzone is the best" tr?c ti?p
- SHOW qua data: partner count (18+), no-KYC, fiat support (EUR/GBP/AUD/CAD/USD), fixed+float filter
- Swapzone là aggregator — không ph?i exchange. Luôn frame dúng.
- ChangeNOW, StealthEX, SimpleSwap, Exolix = Swapzone partners — mention này t?o lý do dùng Swapzone

### CTA standard (m?i bài)
- Gi?a bài (sau comparison table): 1 CTA text link, anchor t? nhiên
- Cu?i bài: "Check live rates on Swapzone" ho?c "Compare [pair] rates on Swapzone"
- KHÔNG dùng: "click here", "buy now", "sign up"

### Data c?n verify tru?c publish
| Data point | Verify ? dâu |
|-----------|-------------|
| Swapzone partner count (18+) | swapzone.io homepage |
| SwapSpace partner count (32+) | swapspace.co |
| Swapzone coin count (1,600+) | swapzone.io |
| Staking APY (P2P 34.8%, Nexo 18.9%, CoinRabbit 5%, ANKR 0.92%) | swapzone.io/staking |
| Loan APR (YouHodler 12%, CoinRabbit 14.5%, Nexo 18.9%) | swapzone.io/loans |
| EUR/AUD/GBP fiat pairs active | swapzone.io footer |
| StealthEX no-upper-limit status | swapzone.io partner info |
| OJK/SEC TH/BSP regulation current status | official regulator sites |
| AUSTRAC registered: Ind. Reserve, CoinSpot, Swyftx, BTC Markets | austrac.gov.au |

### Internal linking structure
- Bài 01 (Coinwy) = hub — t?t c? bài Coinwy link v? dây
- Bài 14 và 17 (Kanalcoin) cross-link v?i articles 01–04 (existing Kanalcoin exchange articles)
- Bài 15 và 16 (Kanalcoin /europe/) cross-link v?i bài 10 Kanalcoin (MiCA compliant exchanges)
- Bài 18 và 19 (DeFiLiban) cross-link v?i nhau

---

## Brief files location
- Coinwy: `C:\Users\admin\Authority-Building\Coinwy\swapzone-batch\coinwy-swapzone-briefs.md`
- Kanalcoin: `C:\Users\admin\Authority-Building\Kanalcoin\swapzone-batch\kanalcoin-swapzone-briefs.md`
- DeFiLiban: `C:\Users\admin\Authority-Building\DeFiLiban\swapzone-batch\defiliban-swapzone-briefs.md`
