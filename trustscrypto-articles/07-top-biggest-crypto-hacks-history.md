...
> **Data freshness:** Dollar loss figures use valuations at the time of each incident. FTX bankruptcy recovery figures reflect the reorganization plan as of mid-2024 — distributions are ongoing and final outcomes are not settled. Ronin Network and Mt. Gox recovery figures are partial; verify current status at respective court or administrator pages.
