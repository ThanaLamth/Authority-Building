...
**Indonesia:** OJK-licensed digital asset exchanges (Indodax, Tokocrypto, Reku, Pintu) require full KYC including national ID and selfie verification. Non-custodial services like Swapzone and StealthEX are accessible without restriction from Indonesian connections. They are not classified as OJK-regulated exchanges under current rules.
...
**Indonesia:** Swapzone or StealthEX for crypto-to-crypto (no KYC). Indodax or Tokocrypto for IDR fiat on-ramp (full KYC required).
