...
meta_description: "A crypto loan is a liquidation mechanism first. Compare YouHodler, Nexo, CoinRabbit, Aave, and Compound by LTV ratio, APR, liquidation threshold, and custody model in 2026."
...
Aave's maximum LTV varies by asset — 80% for ETH, 75% for BTC — with liquidation thresholds typically set 5 to 7.5 percentage points above the maximum LTV. This gives a slightly larger buffer than YouHodler's aggressive 90% LTV.
